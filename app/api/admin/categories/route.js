...
export async function POST(req) {
  ...
  const db = await getDb();
  const r = await db.prepare("INSERT INTO Categories (Name,DisplayOrder,IsActive,ImageUrl,ImagePosition,Note) VALUES ($1,$2,$3,$4,$5,$6) RETURNING CategoryId AS id").run(Name.trim(), DisplayOrder, IsActive ? true : false, ImageUrl || null, ImagePosition || "center", sanitizeHtml(Note) || null);
