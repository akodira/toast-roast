...
export async function PUT(req, { params }) {
  ...
  await db.prepare("UPDATE Categories SET Name=$1,DisplayOrder=$2,IsActive=$3,ImageUrl=$4,ImagePosition=$5,Note=$6 WHERE CategoryId=$7").run(Name.trim(), DisplayOrder, IsActive ? true : false, ImageUrl || null, ImagePosition || "center", sanitizeHtml(Note) || null, params.id);
