...
export async function PUT(req, { params }) {
  ...
  await db.prepare(
    `UPDATE Branches SET Name=$1, Address=$2, Phone=$3, Email=$4, OpeningHours=$5, MapUrl=$6, MapEmbed=$7, MenuPdfUrl=$8,
       TaxPercent=$9, ServicePercent=$10, DisplayOrder=$11, IsActive=$12 WHERE BranchId=$13`
