...
const COLUMN_MAP = {
  ...
  isfeatured: "IsFeatured", imageposition: "ImagePosition",
...
async function seed(p) {
  ...
  const content = {
    ...
    // Shown under the item list on the Menu page. Separate from footer_note
    // so it can be reworded or cleared without touching the site footer.
    menu_note: "All prices are subject to a 12% service charge and 14% VAT.",
    invoice_logo: "",
