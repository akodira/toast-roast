...
async function seed(p) {
  ...
  // One-time cleanup: earlier versions created a new Customer row on every
  // order (no dedup) and never removed one when its order was deleted —
  // this sweeps up any leftover rows with zero orders attached. Safe to
  // run on every deploy since it's a no-op once they're gone.
